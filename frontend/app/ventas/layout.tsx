...
const VENTAS_SECTIONS = [
  {
    title: 'COMERCIAL & CRM B2B',
    items: [
      { href: '/ventas/dashboard', label: 'CRM & Cotizaciones B2B', icon: LayoutDashboard },
    ],
  },
];
    ...
    >
      ...
      >
        <div className="flex flex-col flex-1 overflow-hidden">
          ...
          >
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-400 to-teal-500 text-slate-950 font-black shadow-md shadow-emerald-500/20">
              V
            </div>
            <div>
              ...
              <p className={`text-[9px] font-mono tracking-widest font-bold ${isDark ? 'text-emerald-400' : 'text-emerald-600'}`}>
                VENTAS & ATENCIÓN
              </p>
            </div>
          </div>
        ...
        >
          ...
          <div className="flex items-center gap-2 text-xs font-medium">
            <span className={`font-bold ${isDark ? 'text-slate-200' : 'text-slate-800'}`}>
              Ventas & Atención Digital
            </span>
            <span className="text-slate-400">/</span>
            <span className="text-slate-400 font-mono">CRM, Cotizaciones & Cartera B2B</span>
          </div>
