...
import { Package, Plus, Search, Edit3, Save, X, RefreshCw, Tag, AlertTriangle, CheckCircle2, Trash2 } from 'lucide-react';
...
export default function GestionInventarioPage() {
  ...
  const [form, setForm] = useState({ codigo: '', nombre: '', familiaId: '', unidadMedida: 'KG', tipo: 'BASE', stockMinimo: 0, costoUnitario: 0 });
  ...
  const handleCrearInsumo = async () => {
    ...
    if (ok) { setShowNuevo(false); setForm({ codigo: '', nombre: '', familiaId: '', unidadMedida: 'KG', tipo: 'BASE', stockMinimo: 0, costoUnitario: 0 }); cargar(); }
      ...
      <div className={`p-6 rounded-2xl border ${cardBg}`}>
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className={`text-xl font-black ${textValue}`}>Gestión de Inventario</h1>
