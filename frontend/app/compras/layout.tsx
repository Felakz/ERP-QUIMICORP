...
const COMPRAS_SECTIONS = [
  {
    ...
    items: [
      { href: '/compras/dashboard', label: 'Órdenes de Compra & Proveedores', icon: LayoutDashboard },
    ],
  },
];
    ...
    >
      ...
      >
        <div className="flex flex-col flex-1 overflow-hidden">
          ...
          >
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-amber-500 to-yellow-600 text-slate-950 font-black shadow-md shadow-amber-500/20">
              C
            </div>
            <div>
              ...
              <p className={`text-[9px] font-mono tracking-widest font-bold ${isDark ? 'text-amber-400' : 'text-amber-700'}`}>
          ...
          >
            <div className="flex items-center gap-2.5 overflow-hidden text-left">
              ...
              <div className="overflow-hidden text-left">
                ...
                <p className="text-[9px] text-amber-400 font-mono font-bold truncate uppercase">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        >
          ...
          <div className="flex items-center gap-2 text-xs font-medium">
            ...
            <span className="text-slate-400 font-mono">Órdenes de Compra & Cotización Insumos</span>
          </div>
