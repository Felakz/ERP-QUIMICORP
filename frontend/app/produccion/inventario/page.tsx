...
export default function InventariosPage() {
  ...
  React.useEffect(() => {
    ...
    // WebSockets para sincronización en tiempo real sin presionar F5
    let socket: any = null;
    try {
  ...
  // Abrir modal con insumos críticos o seleccionar uno específico
  ...
  return (
    <div className="space-y-6 font-mono min-h-screen">
      ...
      {/* Main Control & Filter Bar (Estilo Idéntico a Imagen 2) */}
      <div className={`rounded-xl p-4 border space-y-4 ${cardBg}`}>
        <div className="flex flex-wrap items-center justify-between gap-3 font-sans">
          ...
          {/* Dropdown SELECT de Categorías/Familias (Estilo Imagen 2) */}
          <div className="flex items-center gap-2">
            <span className={`text-xs font-bold ${textTitle}`}>CATEGORÍA:</span>
            <select
        ...
        {/* Control de Paginación de 50 en 50 */}
      ...
      {/* Modal de Reaprovisionamiento MÚLTIPLE EN MASA con Dropdown Dinámico en Tiempo Real (Estilo Imagen 3) */}
            ...
            <div className="space-y-4 text-xs">
              ...
              <div className="space-y-3 max-h-64 overflow-y-auto pr-1">
                {listaReaprovisionamiento.map((item, idx) => (
                  ...
                  >
                    {/* Dropdown Dinámico SELECT de Productos (Estilo Imagen 3) */}
