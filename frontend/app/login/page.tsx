...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#080B11] text-slate-100 flex items-center justify-center p-4 sm:p-6 lg:p-12 font-sans relative overflow-hidden">
      ...
      <div className="absolute -bottom-40 right-1/4 w-96 h-96 bg-cyan-700/10 rounded-full blur-[150px] pointer-events-none" />
        ...
        <div className="lg:col-span-7 flex flex-col justify-center space-y-6 max-w-2xl mx-auto lg:mx-0 w-full">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center gap-3.5">
              <div className="h-12 w-12 rounded-2xl bg-gradient-to-tr from-teal-400 via-emerald-400 to-cyan-500 flex items-center justify-center text-slate-950 font-black text-2xl shadow-lg shadow-teal-500/20 ring-1 ring-white/20">
                Q
              </div>
              <div>
                ...
                <p className="text-[11px] sm:text-xs font-semibold tracking-wide text-teal-400">
                  "Innovación a través de la ciencia"
                </p>
              </div>
            </div>

            <div className="flex items-center gap-2 px-3 py-1.5 rounded-full border border-emerald-500/30 bg-emerald-500/10 text-emerald-400 text-[11px] font-semibold">
          ...
          {/* 4 Tarjetas de Gestión Integral (Administración, Comercial, Producción, Logística) */}
          ...
          <div className="p-3.5 rounded-xl border border-teal-500/25 bg-gradient-to-r from-teal-950/30 via-slate-900/40 to-transparent flex items-center gap-3 text-xs text-slate-200">
            <span className="text-xl">🔬</span>
            <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
              <span className="font-bold text-teal-300">QUIMICORP:</span>
